...
Original file is located at
    https://colab.research.google.com/drive/1S6fdHjeZN2wp1rrqm0DDkNt5s92A6ev6
"""
...
with open("/content/svm_model (1).pkl", "rb") as file:
   model = pickle.load(file)


with open("/content/tfidf_vectortizer (1).pkl", "rb") as file:
...
image = Image.open("/content/instagram threads.jpg")
